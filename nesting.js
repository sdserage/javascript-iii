...
var employeeUpdater = () => { // Important that employeeUpdater does not take an arguement, it needs to literally change the array above, not an array it recieves as an arguement.
  console.log("hello");
  var i;
